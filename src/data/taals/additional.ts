  ...
  styles: [
    {
      ...
      thekas: {
        ...
        drut: [
          { name: 'Dhin', position: 1, velocity: 1.0 },
          // position 2 is a sustain/rest
          { name: 'Dha', position: 3, velocity: 0.6 },
          { name: 'Dhin', position: 4, velocity: 0.8 },
          { name: 'Dhin', position: 5, velocity: 0.6 },
          { name: 'Dha', position: 6, velocity: 0.6 },
          { name: 'Ge', position: 7, velocity: 0.5 },
          { name: 'Tin', position: 8, velocity: 0.8 },
          // position 9 is a sustain/rest
          { name: 'Ta', position: 10, velocity: 0.6 },
          { name: 'Dhin', position: 11, velocity: 0.8 },
          { name: 'Dhin', position: 12, velocity: 0.6 },
          { name: 'Dha', position: 13, velocity: 0.6 },
          { name: 'Ge', position: 14, velocity: 0.5 },
        ],
      },
    },
  ],
  ...
  styles: [
    {
      ...
      thekas: {
        vilambit: [
          ...
          { name: 'Ge', position: 13.5, velocity: 0.4 },
          { name: 'Dha', position: 14, velocity: 0.7 },
          { name: 'Dhin', position: 15, velocity: 0.7 },
          { name: 'Trkt', position: 15.5, velocity: 0.4 },
        ...
        drut: [
          { name: 'Dha', position: 1, velocity: 1.0 },
          { name: 'Trkt', position: 2, velocity: 0.5 },
          { name: 'Dhin', position: 3, velocity: 0.6 },
          { name: 'Dhin', position: 4, velocity: 0.6 },
          { name: 'Dha', position: 5, velocity: 0.8 },
          { name: 'Dha', position: 6, velocity: 0.6 },
          { name: 'Tin', position: 7, velocity: 0.6 },
          { name: 'Tin', position: 8, velocity: 0.5 },
          { name: 'Ta', position: 9, velocity: 0.8 },
          { name: 'Trkt', position: 10, velocity: 0.5 },
          { name: 'Dhin', position: 11, velocity: 0.6 },
          { name: 'Dhin', position: 12, velocity: 0.6 },
          { name: 'Dha', position: 13, velocity: 0.8 },
          { name: 'Dha', position: 14, velocity: 0.6 },
          { name: 'Dhin', position: 15, velocity: 0.6 },
          { name: 'Dhin', position: 16, velocity: 0.6 },
        ],
      },
    },
  ],
