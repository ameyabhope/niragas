 ...
 * Theka: Dhin Dhin | Dhage Trkt | Tu Na | Kat Ta | Dhage Trkt | Dhin Na
 * Dhage occupies one matra; Trkt expands to four equal strokes in one matra.
 */
  ...
  styles: [
    {
      ...
      thekas: {
        ...
        madhya: [
          ...
          { name: 'Dhin', position: 2, velocity: 0.7 },
          { name: 'Dha', position: 3, velocity: 0.9 },
          { name: 'Ge', position: 3.5, velocity: 0.6 },
          { name: 'Trkt', position: 4, velocity: 0.6 },
          { name: 'Tu', position: 5, velocity: 0.9 },
          { name: 'Na', position: 6, velocity: 0.7 },
          { name: 'Kat', position: 7, velocity: 0.9 },
          { name: 'Ta', position: 8, velocity: 0.6 },
          { name: 'Dha', position: 9, velocity: 0.9 },
          { name: 'Ge', position: 9.5, velocity: 0.6 },
        ...
        drut: [
          ...
          { name: 'Ge', position: 3.5, velocity: 0.5 },
          { name: 'Trkt', position: 4, velocity: 0.5 },
          { name: 'Tu', position: 5, velocity: 0.8 },
          { name: 'Na', position: 6, velocity: 0.6 },
          { name: 'Kat', position: 7, velocity: 0.8 },
          { name: 'Ta', position: 8, velocity: 0.5 },
          { name: 'Dha', position: 9, velocity: 0.8 },
          { name: 'Ge', position: 9.5, velocity: 0.5 },
